...
Virtari skeleton — accessible React component built on CSS variables and logical properties.
...
```bash
npm install @virtari-packages/react-skeleton
# or
pnpm add @virtari-packages/react-skeleton
# or
yarn add @virtari-packages/react-skeleton
```
...
```tsx
import { /* … */ } from "@virtari-packages/react-skeleton";
```

### Import styles

```ts
import "@virtari-packages/react-skeleton/styles";
```
