...
```bash
npm install @virtari/react-skeleton
# or
pnpm add @virtari/react-skeleton
# or
yarn add @virtari/react-skeleton
```
...
```tsx
import { /* ... */ } from "@virtari/react-skeleton";
```

### Import styles

```ts
import "@virtari/react-skeleton/styles";
```
