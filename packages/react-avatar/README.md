...
```bash
npm install @virtari/react-avatar
# or
pnpm add @virtari/react-avatar
# or
yarn add @virtari/react-avatar
```
...
```tsx
import { /* ... */ } from "@virtari/react-avatar";
```

### Import styles

```ts
import "@virtari/react-avatar/styles";
```
