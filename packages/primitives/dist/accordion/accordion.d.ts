...
declare const createAccordionScope: import("../context").CreateScope;
...
export { createAccordionScope, Accordion, AccordionItem, AccordionHeader, AccordionTrigger, AccordionContent, Root, Item, Header, Trigger, Content, };
