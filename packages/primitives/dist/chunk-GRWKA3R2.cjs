...
var chunkBCOBWW4R_cjs = require('./chunk-BCOBWW4R.cjs');
...
var DismissableLayer = React__namespace.forwardRef(
  (props, forwardedRef) => {
    ...
    chunkBCOBWW4R_cjs.useEscapeKeydown((event) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(
      chunkVMBJPRF6_cjs.Primitive.div,
      {
        ...
        onFocusCapture: chunkHZZGSTKH_cjs.composeEventHandlers(props.onFocusCapture, focusOutside.onFocusCapture),
        onBlurCapture: chunkHZZGSTKH_cjs.composeEventHandlers(props.onBlurCapture, focusOutside.onBlurCapture),
        onPointerDownCapture: chunkHZZGSTKH_cjs.composeEventHandlers(
...
var DismissableLayerBranch = React__namespace.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(chunkVMBJPRF6_cjs.Primitive.div, { ...props, ref: composedRefs });
});
DismissableLayerBranch.displayName = BRANCH_NAME;
function usePointerDownOutside(onPointerDownOutside, ownerDocument = globalThis?.document) {
  const handlePointerDownOutside = chunkBAVCHO4C_cjs.useCallbackRef(onPointerDownOutside);
...
function useFocusOutside(onFocusOutside, ownerDocument = globalThis?.document) {
  const handleFocusOutside = chunkBAVCHO4C_cjs.useCallbackRef(onFocusOutside);
...
function handleAndDispatchCustomEvent(name, handler, detail, { discrete }) {
  ...
  if (discrete) {
    chunkVMBJPRF6_cjs.dispatchDiscreteCustomEvent(target, event);
  } else {
