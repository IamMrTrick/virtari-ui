...
var [Collection, useCollection, createCollectionScope] = chunkLMPOMJMC_cjs.createCollection(GROUP_NAME);
var [createRovingFocusGroupContext, createRovingFocusGroupScope] = chunkIF4KNLHI_cjs.createContextScope(
  GROUP_NAME,
...
var RovingFocusGroupImpl = React__namespace.forwardRef((props, forwardedRef) => {
  ...
  const [currentTabStopId, setCurrentTabStopId] = chunkNFW6EKVN_cjs.useControllableState({
  ...
  const handleEntryFocus = chunkBAVCHO4C_cjs.useCallbackRef(onEntryFocus);
    ...
    RovingFocusProvider,
    {
      ...
      children: /* @__PURE__ */ jsxRuntime.jsx(
        chunkVMBJPRF6_cjs.Primitive.div,
        {
          ...
          onMouseDown: chunkHZZGSTKH_cjs.composeEventHandlers(props.onMouseDown, () => {
            isClickFocusRef.current = true;
          }),
          onFocus: chunkHZZGSTKH_cjs.composeEventHandlers(props.onFocus, (event) => {
          ...
          onBlur: chunkHZZGSTKH_cjs.composeEventHandlers(props.onBlur, () => setIsTabbingBackOut(false))
        }
      )
    }
  );
...
var RovingFocusGroupItem = React__namespace.forwardRef(
  (props, forwardedRef) => {
    ...
    const autoId = chunkRPLT3BNS_cjs.useId();
      ...
      Collection.ItemSlot,
      {
        ...
        children: /* @__PURE__ */ jsxRuntime.jsx(
          chunkVMBJPRF6_cjs.Primitive.span,
          {
            ...
            onFocus: chunkHZZGSTKH_cjs.composeEventHandlers(props.onFocus, () => context.onItemFocus(id)),
