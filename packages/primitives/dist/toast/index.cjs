...
var [Collection, useCollection, createCollectionScope] = chunkLMPOMJMC_cjs.createCollection("Toast");
var [createToastContext, createToastScope] = chunkIF4KNLHI_cjs.createContextScope("Toast", [createCollectionScope]);
...
var ToastViewport = React__namespace.forwardRef(
  (props, forwardedRef) => {
    ...
    const composedRefs = chunkBMTE6ZMC_cjs.useComposedRefs(forwardedRef, ref, context.onViewportChange);
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(
      chunkGRWKA3R2_cjs.Branch,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsx(Collection.Slot, { scope: __scopeToast, children: /* @__PURE__ */ jsxRuntime.jsx(chunkVMBJPRF6_cjs.Primitive.ol, { tabIndex: -1, ...viewportProps, ref: composedRefs }) }),
          hasToasts && /* @__PURE__ */ jsxRuntime.jsx(
            FocusProxy,
            {
...
var FocusProxy = React__namespace.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(
      chunkPZNGIPGH_cjs.VisuallyHidden,
      {
        tabIndex: 0,
        ...proxyProps,
        ref: forwardedRef,
...
var Toast = React__namespace.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(chunkT6B7B45H_cjs.Presence, { present: forceMount || open, children: /* @__PURE__ */ jsxRuntime.jsx(
      ToastImpl,
      {
        open,
        ...toastProps,
        ...
        onPause: chunkBAVCHO4C_cjs.useCallbackRef(props.onPause),
        onResume: chunkBAVCHO4C_cjs.useCallbackRef(props.onResume),
        onSwipeStart: chunkHZZGSTKH_cjs.composeEventHandlers(props.onSwipeStart, (event) => {
          event.currentTarget.setAttribute("data-swipe", "start");
        }),
        onSwipeMove: chunkHZZGSTKH_cjs.composeEventHandlers(props.onSwipeMove, (event) => {
          const { x, y } = event.detail.delta;
          event.currentTarget.setAttribute("data-swipe", "move");
          event.currentTarget.style.setProperty("--vds-toast-swipe-move-x", `${x}px`);
          event.currentTarget.style.setProperty("--vds-toast-swipe-move-y", `${y}px`);
        }),
        onSwipeCancel: chunkHZZGSTKH_cjs.composeEventHandlers(props.onSwipeCancel, (event) => {
          event.currentTarget.setAttribute("data-swipe", "cancel");
          event.currentTarget.style.removeProperty("--vds-toast-swipe-move-x");
          event.currentTarget.style.removeProperty("--vds-toast-swipe-move-y");
          event.currentTarget.style.removeProperty("--vds-toast-swipe-end-x");
          event.currentTarget.style.removeProperty("--vds-toast-swipe-end-y");
        }),
        onSwipeEnd: chunkHZZGSTKH_cjs.composeEventHandlers(props.onSwipeEnd, (event) => {
          const { x, y } = event.detail.delta;
          event.currentTarget.setAttribute("data-swipe", "end");
          event.currentTarget.style.removeProperty("--vds-toast-swipe-move-x");
          event.currentTarget.style.removeProperty("--vds-toast-swipe-move-y");
          event.currentTarget.style.setProperty("--vds-toast-swipe-end-x", `${x}px`);
          event.currentTarget.style.setProperty("--vds-toast-swipe-end-y", `${y}px`);
          setOpen(false);
        })
      }
    ) });
...
var ToastImpl = React__namespace.forwardRef(
  (props, forwardedRef) => {
    ...
    const composedRefs = chunkBMTE6ZMC_cjs.useComposedRefs(forwardedRef, (node2) => setNode(node2));
    ...
    const handleClose = chunkBAVCHO4C_cjs.useCallbackRef(() => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsx(ToastInteractiveProvider, { scope: __scopeToast, onClose: handleClose, children: ReactDOM__namespace.createPortal(
        /* @__PURE__ */ jsxRuntime.jsx(Collection.ItemSlot, { scope: __scopeToast, children: /* @__PURE__ */ jsxRuntime.jsx(
          chunkGRWKA3R2_cjs.Root,
          {
            asChild: true,
            onEscapeKeyDown: chunkHZZGSTKH_cjs.composeEventHandlers(onEscapeKeyDown, () => {
              if (!context.isFocusedToastEscapeKeyDownRef.current) handleClose();
              context.isFocusedToastEscapeKeyDownRef.current = false;
            }),
            children: /* @__PURE__ */ jsxRuntime.jsx(
              chunkVMBJPRF6_cjs.Primitive.li,
              {
                tabIndex: 0,
...
var ToastAnnounce = (props) => {
  ...
  return isAnnounced ? null : /* @__PURE__ */ jsxRuntime.jsx(chunkLMWRQN3H_cjs.Portal, { asChild: true, children: /* @__PURE__ */ jsxRuntime.jsx(chunkPZNGIPGH_cjs.VisuallyHidden, { ...announceProps, children: renderAnnounceText && /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    context.label,
    " ",
    children
  ] }) }) });
...
var ToastTitle = React__namespace.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(chunkVMBJPRF6_cjs.Primitive.div, { ...titleProps, ref: forwardedRef });
  }
);
...
var ToastDescription = React__namespace.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(chunkVMBJPRF6_cjs.Primitive.div, { ...descriptionProps, ref: forwardedRef });
  }
);
...
var ToastAction = React__namespace.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(ToastAnnounceExclude, { altText, asChild: true, children: /* @__PURE__ */ jsxRuntime.jsx(ToastClose, { ...actionProps, ref: forwardedRef }) });
  }
);
  ...
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(ToastAnnounceExclude, { asChild: true, children: /* @__PURE__ */ jsxRuntime.jsx(
      chunkVMBJPRF6_cjs.Primitive.button,
      {
        ...
        ...closeProps,
        ref: forwardedRef,
        onClick: chunkHZZGSTKH_cjs.composeEventHandlers(props.onClick, interactiveContext.onClose)
      }
    ) });
  }
);
...
var ToastAnnounceExclude = React__namespace.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    ...
    {
      "data-vds-toast-announce-exclude": "",
      "data-vds-toast-announce-alt": altText || void 0,
...
function getAnnounceTextContent(container) {
  ...
  childNodes.forEach((node) => {
    ...
    if (isHTMLElement(node)) {
      ...
      const isExcluded = node.dataset.vdsToastAnnounceExclude === "";
      if (!isHidden) {
        if (isExcluded) {
          const altText = node.dataset.vdsToastAnnounceAlt;
...
function handleAndDispatchCustomEvent(name, handler, detail, { discrete }) {
  ...
  if (discrete) {
    chunkVMBJPRF6_cjs.dispatchDiscreteCustomEvent(currentTarget, event);
  } else {
...
function useNextFrame(callback = () => {
  ...
  const fn = chunkBAVCHO4C_cjs.useCallbackRef(callback);
...
exports.createToastScope = createToastScope;
