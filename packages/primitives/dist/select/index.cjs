...
var chunkHWZN3YDV_cjs = require('../chunk-HWZN3YDV.cjs');
...
var [Collection, useCollection, createCollectionScope] = chunkLMPOMJMC_cjs.createCollection(SELECT_NAME);
var [createSelectContext, createSelectScope] = chunkIF4KNLHI_cjs.createContextScope(SELECT_NAME, [
...
var Select = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(chunkZPMLOBZ2_cjs.Root, { ...popperScope, children: /* @__PURE__ */ jsxRuntime.jsxs(
    SelectProvider,
    {
      required,
      scope: __scopeSelect,
...
var SelectTrigger = React__namespace.forwardRef(
  (props, forwardedRef) => {
    ...
    const composedRefs = chunkBMTE6ZMC_cjs.useComposedRefs(forwardedRef, context.onTriggerChange);
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(chunkZPMLOBZ2_cjs.Anchor, { asChild: true, ...popperScope, children: /* @__PURE__ */ jsxRuntime.jsx(
      chunkVMBJPRF6_cjs.Primitive.button,
      {
        ...
        ...triggerProps,
        ref: composedRefs,
        onClick: chunkHZZGSTKH_cjs.composeEventHandlers(triggerProps.onClick, (event) => {
          event.currentTarget.focus();
          if (pointerTypeRef.current !== "mouse") {
            handleOpen(event);
          }
        }),
        onPointerDown: chunkHZZGSTKH_cjs.composeEventHandlers(triggerProps.onPointerDown, (event) => {
        ...
        onKeyDown: chunkHZZGSTKH_cjs.composeEventHandlers(triggerProps.onKeyDown, (event) => {
...
var SelectValue = React__namespace.forwardRef(
  (props, forwardedRef) => {
    ...
    const composedRefs = chunkBMTE6ZMC_cjs.useComposedRefs(forwardedRef, context.onValueNodeChange);
...
var SelectIcon = React__namespace.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(chunkVMBJPRF6_cjs.Primitive.span, { "aria-hidden": true, ...iconProps, ref: forwardedRef, children: children || "\u25BC" });
  }
);
SelectIcon.displayName = ICON_NAME;
var PORTAL_NAME = "SelectPortal";
var SelectPortal = (props) => {
  return /* @__PURE__ */ jsxRuntime.jsx(chunkLMWRQN3H_cjs.Portal, { asChild: true, ...props });
};
...
var Slot = chunk3W3I2SIR_cjs.createSlot("SelectContent.RemoveScroll");
var SelectContentImpl = React__namespace.forwardRef(
  (props, forwardedRef) => {
    ...
    const composedRefs = chunkBMTE6ZMC_cjs.useComposedRefs(forwardedRef, (node) => setContent(node));
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(
      SelectContentProvider,
      {
        ...
        isPositioned,
        searchRef,
        children: /* @__PURE__ */ jsxRuntime.jsx(reactRemoveScroll.RemoveScroll, { as: Slot, allowPinchZoom: true, children: /* @__PURE__ */ jsxRuntime.jsx(
          chunkJV2CZCUL_cjs.FocusScope,
          {
            ...
            onUnmountAutoFocus: chunkHZZGSTKH_cjs.composeEventHandlers(onCloseAutoFocus, (event) => {
...
var SelectItemAlignedPosition = React__namespace.forwardRef((props, forwardedRef) => {
  ...
  const position = React__namespace.useCallback(() => {
    if (context.trigger && context.valueNode && contentWrapper && content && viewport && selectedItem && selectedItemText) {
      ...
      if (context.dir !== "rtl") {
        ...
        const clampedLeft = chunkHWZN3YDV_cjs.clamp(left, [
          CONTENT_MARGIN,
        ...
        const clampedRight = chunkHWZN3YDV_cjs.clamp(right, [
          CONTENT_MARGIN,
  ...
  chunkSREYN7I5_cjs.useLayoutEffect(() => position(), [position]);
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    chunkZPMLOBZ2_cjs.Content,
    {
      ...
      style: {
        ...
        ...{
          "--vds-select-content-transform-origin": "var(--vds-popper-transform-origin)",
          "--vds-select-content-available-width": "var(--vds-popper-available-width)",
          "--vds-select-content-available-height": "var(--vds-popper-available-height)",
          "--vds-select-trigger-width": "var(--vds-popper-anchor-width)",
          "--vds-select-trigger-height": "var(--vds-popper-anchor-height)"
        }
      }
    }
  );
...
var SelectViewport = React__namespace.forwardRef(
  (props, forwardedRef) => {
    ...
    const composedRefs = chunkBMTE6ZMC_cjs.useComposedRefs(forwardedRef, contentContext.onViewportChange);
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
      /* @__PURE__ */ jsxRuntime.jsx(
        "style",
        {
          dangerouslySetInnerHTML: {
            __html: `[data-vds-select-viewport]{scrollbar-width:none;-ms-overflow-style:none;-webkit-overflow-scrolling:touch;}[data-vds-select-viewport]::-webkit-scrollbar{display:none}`
          },
          nonce
        }
      ),
      /* @__PURE__ */ jsxRuntime.jsx(Collection.Slot, { scope: __scopeSelect, children: /* @__PURE__ */ jsxRuntime.jsx(
        chunkVMBJPRF6_cjs.Primitive.div,
        {
          ...
          onScroll: chunkHZZGSTKH_cjs.composeEventHandlers(viewportProps.onScroll, (event) => {
...
var SelectGroup = React__namespace.forwardRef(
  (props, forwardedRef) => {
    ...
    const groupId = chunkRPLT3BNS_cjs.useId();
    return /* @__PURE__ */ jsxRuntime.jsx(SelectGroupContextProvider, { scope: __scopeSelect, id: groupId, children: /* @__PURE__ */ jsxRuntime.jsx(chunkVMBJPRF6_cjs.Primitive.div, { role: "group", "aria-labelledby": groupId, ...groupProps, ref: forwardedRef }) });
  }
);
...
var SelectLabel = React__namespace.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(chunkVMBJPRF6_cjs.Primitive.div, { id: groupContext.id, ...labelProps, ref: forwardedRef });
  }
);
...
var SelectItem = React__namespace.forwardRef(
  (props, forwardedRef) => {
    ...
    const composedRefs = chunkBMTE6ZMC_cjs.useComposedRefs(
      forwardedRef,
      (node) => contentContext.itemRefCallback?.(node, value, disabled)
    );
    const textId = chunkRPLT3BNS_cjs.useId();
    const pointerTypeRef = React__namespace.useRef("touch");
    const handleSelect = () => {
      if (!disabled) {
          ...
          Collection.ItemSlot,
          {
            ...
            children: /* @__PURE__ */ jsxRuntime.jsx(
              chunkVMBJPRF6_cjs.Primitive.div,
              {
                ...
                ...itemProps,
                ref: composedRefs,
                onFocus: chunkHZZGSTKH_cjs.composeEventHandlers(itemProps.onFocus, () => setIsFocused(true)),
                onBlur: chunkHZZGSTKH_cjs.composeEventHandlers(itemProps.onBlur, () => setIsFocused(false)),
                onClick: chunkHZZGSTKH_cjs.composeEventHandlers(itemProps.onClick, () => {
                  if (pointerTypeRef.current !== "mouse") handleSelect();
                }),
                onPointerUp: chunkHZZGSTKH_cjs.composeEventHandlers(itemProps.onPointerUp, () => {
                  if (pointerTypeRef.current === "mouse") handleSelect();
                }),
                onPointerDown: chunkHZZGSTKH_cjs.composeEventHandlers(itemProps.onPointerDown, (event) => {
                  pointerTypeRef.current = event.pointerType;
                }),
                onPointerMove: chunkHZZGSTKH_cjs.composeEventHandlers(itemProps.onPointerMove, (event) => {
                  pointerTypeRef.current = event.pointerType;
                  if (disabled) {
                ...
                onPointerLeave: chunkHZZGSTKH_cjs.composeEventHandlers(itemProps.onPointerLeave, (event) => {
                  if (event.currentTarget === document.activeElement) {
                    contentContext.onItemLeave?.();
                  }
                }),
                onKeyDown: chunkHZZGSTKH_cjs.composeEventHandlers(itemProps.onKeyDown, (event) => {
...
var SelectItemText = React__namespace.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
      /* @__PURE__ */ jsxRuntime.jsx(chunkVMBJPRF6_cjs.Primitive.span, { id: itemContext.textId, ...itemTextProps, ref: composedRefs }),
...
var SelectItemIndicator = React__namespace.forwardRef(
  (props, forwardedRef) => {
    ...
    return itemContext.isSelected ? /* @__PURE__ */ jsxRuntime.jsx(chunkVMBJPRF6_cjs.Primitive.span, { "aria-hidden": true, ...itemIndicatorProps, ref: forwardedRef }) : null;
  }
);
...
var SelectScrollUpButton = React__namespace.forwardRef((props, forwardedRef) => {
  ...
  const composedRefs = chunkBMTE6ZMC_cjs.useComposedRefs(forwardedRef, viewportContext.onScrollButtonChange);
  chunkSREYN7I5_cjs.useLayoutEffect(() => {
...
var SelectScrollButtonImpl = React__namespace.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    chunkVMBJPRF6_cjs.Primitive.div,
    {
      ...
      onPointerDown: chunkHZZGSTKH_cjs.composeEventHandlers(scrollIndicatorProps.onPointerDown, () => {
        if (autoScrollTimerRef.current === null) {
          autoScrollTimerRef.current = window.setInterval(onAutoScroll, 50);
        }
      }),
      onPointerMove: chunkHZZGSTKH_cjs.composeEventHandlers(scrollIndicatorProps.onPointerMove, () => {
        contentContext.onItemLeave?.();
        if (autoScrollTimerRef.current === null) {
          autoScrollTimerRef.current = window.setInterval(onAutoScroll, 50);
        }
      }),
      onPointerLeave: chunkHZZGSTKH_cjs.composeEventHandlers(scrollIndicatorProps.onPointerLeave, () => {
        clearAutoScrollTimer();
      })
    }
  );
...
var SelectSeparator = React__namespace.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(chunkVMBJPRF6_cjs.Primitive.div, { "aria-hidden": true, ...separatorProps, ref: forwardedRef });
  }
);
...
var SelectArrow = React__namespace.forwardRef(
  (props, forwardedRef) => {
    ...
    return context.open && contentContext.position === "popper" ? /* @__PURE__ */ jsxRuntime.jsx(chunkZPMLOBZ2_cjs.Arrow, { ...popperScope, ...arrowProps, ref: forwardedRef }) : null;
  }
);
...
var SelectBubbleInput = React__namespace.forwardRef(
  ({ __scopeSelect, value, ...props }, forwardedRef) => {
    ...
    const prevValue = chunk3VHNHLD6_cjs.usePrevious(value);
    React__namespace.useEffect(() => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(
      chunkVMBJPRF6_cjs.Primitive.select,
      {
        ...props,
        style: { ...chunkPZNGIPGH_cjs.VISUALLY_HIDDEN_STYLES, ...props.style },
        ref: composedRefs,
        defaultValue: value
      }
    );
...
function useTypeaheadSearch(onSearchChange) {
  const handleSearchChange = chunkBAVCHO4C_cjs.useCallbackRef(onSearchChange);
