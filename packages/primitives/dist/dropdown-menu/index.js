import { createMenuScope, Anchor, Content, Group, Label, Item, CheckboxItem, RadioGroup, RadioItem, ItemIndicator, Separator, Arrow, SubTrigger, SubContent, Root, Portal, Sub } from '../chunk-NRGAEVZT.js';
...
import { composeRefs } from '../chunk-ER6L2S4U.js';
...
var DropdownMenu = (props) => {
  ...
  return /* @__PURE__ */ jsx(
    DropdownMenuProvider,
    {
      ...
      modal,
      children: /* @__PURE__ */ jsx(Root, { ...menuScope, open, onOpenChange: setOpen, dir, modal, children })
    }
  );
};
...
var DropdownMenuTrigger = React.forwardRef(
  (props, forwardedRef) => {
    ...
    const menuScope = useMenuScope(__scopeDropdownMenu);
    return /* @__PURE__ */ jsx(Anchor, { asChild: true, ...menuScope, children: /* @__PURE__ */ jsx(
      Primitive.button,
      {
        type: "button",
...
var DropdownMenuItem = React.forwardRef(
  (props, forwardedRef) => {
    ...
    const menuScope = useMenuScope(__scopeDropdownMenu);
    return /* @__PURE__ */ jsx(Item, { ...menuScope, ...itemProps, ref: forwardedRef });
  }
);
...
var DropdownMenuArrow = React.forwardRef(
  (props, forwardedRef) => {
    ...
    const menuScope = useMenuScope(__scopeDropdownMenu);
    return /* @__PURE__ */ jsx(Arrow, { ...menuScope, ...arrowProps, ref: forwardedRef });
  }
);
