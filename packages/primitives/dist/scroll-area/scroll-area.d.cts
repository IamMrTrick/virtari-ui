...
declare const createScrollAreaScope: import("../context").CreateScope;
...
export { createScrollAreaScope, ScrollArea, ScrollAreaViewport, ScrollAreaScrollbar, ScrollAreaThumb, ScrollAreaCorner, Root, Viewport, Scrollbar, Thumb, Corner, };
