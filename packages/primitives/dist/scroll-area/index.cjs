...
var [createScrollAreaContext, createScrollAreaScope] = chunkIF4KNLHI_cjs.createContextScope(SCROLL_AREA_NAME);
...
var ScrollArea = React2__namespace.forwardRef(
  (props, forwardedRef) => {
    ...
    const composedRefs = chunkBMTE6ZMC_cjs.useComposedRefs(forwardedRef, (node) => setScrollArea(node));
        ...
        children: /* @__PURE__ */ jsxRuntime.jsx(
          chunkVMBJPRF6_cjs.Primitive.div,
          {
            ...
            style: {
              ...
              ["--vds-scroll-area-corner-width"]: cornerWidth + "px",
              ["--vds-scroll-area-corner-height"]: cornerHeight + "px",
              ...props.style
            }
          }
        )
      ...
      /* @__PURE__ */ jsxRuntime.jsx(
        "style",
        {
          dangerouslySetInnerHTML: {
            __html: `[data-vds-scroll-area-viewport]{scrollbar-width:none;-ms-overflow-style:none;-webkit-overflow-scrolling:touch;}[data-vds-scroll-area-viewport]::-webkit-scrollbar{display:none}`
          },
          nonce
        }
      ),
...
var ScrollAreaScrollbarHover = React2__namespace.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(chunkT6B7B45H_cjs.Presence, { present: forceMount || visible, children: /* @__PURE__ */ jsxRuntime.jsx(
...
var ScrollAreaScrollbarScroll = React2__namespace.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(chunkT6B7B45H_cjs.Presence, { present: forceMount || state !== "hidden", children: /* @__PURE__ */ jsxRuntime.jsx(
    ScrollAreaScrollbarVisible,
    {
      "data-state": state === "hidden" ? "hidden" : "visible",
      ...scrollbarProps,
      ref: forwardedRef,
      onPointerEnter: chunkHZZGSTKH_cjs.composeEventHandlers(props.onPointerEnter, () => send("POINTER_ENTER")),
      onPointerLeave: chunkHZZGSTKH_cjs.composeEventHandlers(props.onPointerLeave, () => send("POINTER_LEAVE"))
    }
  ) });
});
...
var ScrollAreaScrollbarX = React2__namespace.forwardRef((props, forwardedRef) => {
  ...
  const ref = React2__namespace.useRef(null);
  const composeRefs = chunkBMTE6ZMC_cjs.useComposedRefs(forwardedRef, ref, context.onScrollbarXChange);
  React2__namespace.useEffect(() => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    ScrollAreaScrollbarImpl,
    {
      ...
      style: {
        bottom: 0,
        left: context.dir === "rtl" ? "var(--vds-scroll-area-corner-width)" : 0,
        right: context.dir === "ltr" ? "var(--vds-scroll-area-corner-width)" : 0,
        ["--vds-scroll-area-thumb-width"]: getThumbSize(sizes) + "px",
        ...props.style
      },
...
var ScrollAreaScrollbarY = React2__namespace.forwardRef((props, forwardedRef) => {
  ...
  const [computedStyle, setComputedStyle] = React2__namespace.useState();
  const ref = React2__namespace.useRef(null);
  const composeRefs = chunkBMTE6ZMC_cjs.useComposedRefs(forwardedRef, ref, context.onScrollbarYChange);
  React2__namespace.useEffect(() => {
    if (ref.current) setComputedStyle(getComputedStyle(ref.current));
  }, [ref]);
  return /* @__PURE__ */ jsxRuntime.jsx(
    ScrollAreaScrollbarImpl,
    {
      ...
      style: {
        ...
        bottom: "var(--vds-scroll-area-corner-height)",
        ["--vds-scroll-area-thumb-height"]: getThumbSize(sizes) + "px",
        ...props.style
      },
...
var ScrollAreaScrollbarImpl = React2__namespace.forwardRef((props, forwardedRef) => {
  ...
  const composeRefs = chunkBMTE6ZMC_cjs.useComposedRefs(forwardedRef, (node) => setScrollbar(node));
  const rectRef = React2__namespace.useRef(null);
  const prevWebkitUserSelectRef = React2__namespace.useRef("");
  const viewport = context.viewport;
  const maxScrollPos = sizes.content - sizes.viewport;
  const handleWheelScroll = chunkBAVCHO4C_cjs.useCallbackRef(onWheelScroll);
  const handleThumbPositionChange = chunkBAVCHO4C_cjs.useCallbackRef(onThumbPositionChange);
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    ScrollbarProvider,
    {
      ...
      scrollbar,
      hasThumb,
      onThumbChange: chunkBAVCHO4C_cjs.useCallbackRef(onThumbChange),
      onThumbPointerUp: chunkBAVCHO4C_cjs.useCallbackRef(onThumbPointerUp),
      onThumbPositionChange: handleThumbPositionChange,
      onThumbPointerDown: chunkBAVCHO4C_cjs.useCallbackRef(onThumbPointerDown),
      children: /* @__PURE__ */ jsxRuntime.jsx(
        chunkVMBJPRF6_cjs.Primitive.div,
        {
          ...scrollbarProps,
          ...
          onPointerMove: chunkHZZGSTKH_cjs.composeEventHandlers(props.onPointerMove, handleDragScroll),
...
var ScrollAreaThumb = React2__namespace.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(chunkT6B7B45H_cjs.Presence, { present: forceMount || scrollbarContext.hasThumb, children: /* @__PURE__ */ jsxRuntime.jsx(ScrollAreaThumbImpl, { ref: forwardedRef, ...thumbProps }) });
  }
);
var ScrollAreaThumbImpl = React2__namespace.forwardRef(
  (props, forwardedRef) => {
    ...
    const composedRef = chunkBMTE6ZMC_cjs.useComposedRefs(
      forwardedRef,
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(
      chunkVMBJPRF6_cjs.Primitive.div,
      {
        ...
        ref: composedRef,
        style: {
          width: "var(--vds-scroll-area-thumb-width)",
          height: "var(--vds-scroll-area-thumb-height)",
          ...style
        },
        onPointerDownCapture: chunkHZZGSTKH_cjs.composeEventHandlers(props.onPointerDownCapture, (event) => {
        ...
        onPointerUp: chunkHZZGSTKH_cjs.composeEventHandlers(props.onPointerUp, scrollbarContext.onThumbPointerUp)
      }
    );
  }
);
...
function getThumbOffsetFromScroll(scrollPos, sizes, dir = "ltr") {
  ...
  const scrollWithoutMomentum = chunkHWZN3YDV_cjs.clamp(scrollPos, scrollClampRange);
...
function useDebounceCallback(callback, delay) {
  const handleCallback = chunkBAVCHO4C_cjs.useCallbackRef(callback);
...
function useResizeObserver(element, onResize) {
  const handleResize = chunkBAVCHO4C_cjs.useCallbackRef(onResize);
...
exports.createScrollAreaScope = createScrollAreaScope;
