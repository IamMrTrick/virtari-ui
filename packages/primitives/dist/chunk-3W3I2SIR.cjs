  ...
  const SlotClone = React__namespace.forwardRef((props, forwardedRef) => {
    ...
    if (React__namespace.isValidElement(children)) {
      ...
      if (children.type !== React__namespace.Fragment) {
        props2.ref = forwardedRef ? chunkBMTE6ZMC_cjs.composeRefs(forwardedRef, childrenRef) : childrenRef;
      }
...
function isSlottable(child) {
  return React__namespace.isValidElement(child) && typeof child.type === "function" && "__vdsId" in child.type && child.type.__vdsId === SLOTTABLE_IDENTIFIER;
}
