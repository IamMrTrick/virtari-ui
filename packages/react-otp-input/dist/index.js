...
function OtpInput({
  ...
  const lastCompletedValue = useRef(null);
  ...
  const focusSlot = useCallback((index, select = true) => {
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        ...
        name ? /* @__PURE__ */ jsx("input", { type: "hidden", name, value: sanitizedValue, readOnly: true }) : null
      ]
    }
  );
}
