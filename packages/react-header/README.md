...
```bash
npm install @virtari/react-header
# or
pnpm add @virtari/react-header
# or
yarn add @virtari/react-header
```
...
```tsx
import { /* … */ } from "@virtari/react-header";
```

### Import styles

```ts
import "@virtari/react-header/styles";
```
