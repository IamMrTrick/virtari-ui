...
import { MarkerType, ReactFlow, ConnectionLineType, Background, BackgroundVariant, MiniMap, Controls, Handle, getSmoothStepPath, EdgeLabelRenderer, useReactFlow, Position } from '@xyflow/react';
import { useMemo, useCallback, useState, useEffect } from 'react';
import { jsxs, jsx, Fragment } from 'react/jsx-runtime';

// src/FlowCanvas.tsx
function useDocumentColorMode(explicitColorMode) {
  const [mode, setMode] = useState(explicitColorMode ?? "dark");
  useEffect(() => {
  ...
  return /* @__PURE__ */ jsxs(
    ReactFlow,
    {
      ...
      children: [
        ...
        showControls ? /* @__PURE__ */ jsx(Controls, { showInteractive: false }) : null,
        children
      ]
    }
  );
...
function FlowNodeHeader({
  ...
  return /* @__PURE__ */ jsx("div", { className: cn("vds-flow-node-header", className), ...props });
}
function FlowNodeBody({
  className,
  ...props
}) {
  return /* @__PURE__ */ jsx("div", { className: cn("vds-flow-node-body", className), ...props });
}
function FlowNodeFooter({
  className,
  ...props
}) {
  return /* @__PURE__ */ jsx("div", { className: cn("vds-flow-node-footer", className), ...props });
}
function FlowNodeEyebrow({
  className,
  ...props
}) {
  return /* @__PURE__ */ jsx("p", { className: cn("vds-flow-node-eyebrow", className), ...props });
}
function FlowNodeTitle({
  className,
  ...props
}) {
  return /* @__PURE__ */ jsx("h3", { className: cn("vds-flow-node-title", className), ...props });
}
function FlowNodeMeta({
  className,
  ...props
}) {
  return /* @__PURE__ */ jsx("p", { className: cn("vds-flow-node-meta", className), ...props });
}
function FlowNodeDescription({
  className,
  ...props
}) {
  return /* @__PURE__ */ jsx("p", { className: cn("vds-flow-node-description", className), ...props });
}
function FlowNodeStats({
  className,
  ...props
}) {
  return /* @__PURE__ */ jsx("div", { className: cn("vds-flow-node-stats", className), ...props });
}
function FlowNodeStat({
  className,
  ...props
}) {
  return /* @__PURE__ */ jsx("div", { className: cn("vds-flow-node-stat", className), ...props });
}
function FlowNodeStatLabel({
  className,
  ...props
}) {
  return /* @__PURE__ */ jsx("span", { className: cn("vds-flow-node-stat-label", className), ...props });
}
function FlowNodeStatValue({
  className,
  ...props
}) {
  return /* @__PURE__ */ jsx("span", { className: cn("vds-flow-node-stat-value", className), ...props });
}
function FlowNodeActions({
  className,
  ...props
}) {
  return /* @__PURE__ */ jsx("div", { className: cn("vds-flow-node-actions", className), ...props });
}
function FlowHandle({
  className,
  size = "md",
...
function FlowBadgeEdge({
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx("path", { d: edgePath, className: "react-flow__edge-interaction", style: interactionStrokeStyle }),
    data?.label ? /* @__PURE__ */ jsx(EdgeLabelRenderer, { children: /* @__PURE__ */ jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxs("span", { className: "vds-flow-edge-label", "data-tone": data.tone ?? "neutral", children: [
          /* @__PURE__ */ jsx("span", { className: "vds-flow-edge-dot", "aria-hidden": "true" }),
          data.label
        ] })
      }
    ) }) : null
...
export { FlowBadgeEdge, FlowCanvas, FlowHandle, FlowNodeActions, FlowNodeBody, FlowNodeDescription, FlowNodeEyebrow, FlowNodeFooter, FlowNodeHeader, FlowNodeMeta, FlowNodeShell, FlowNodeStat, FlowNodeStatLabel, FlowNodeStatValue, FlowNodeStats, FlowNodeTitle, layoutElements, useFlowPersistence };
