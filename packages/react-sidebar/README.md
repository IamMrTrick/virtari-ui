...
```bash
npm install @virtari/react-sidebar
# or
pnpm add @virtari/react-sidebar
# or
yarn add @virtari/react-sidebar
```
...
```tsx
import { /* … */ } from "@virtari/react-sidebar";
```

### Import styles

```ts
import "@virtari/react-sidebar/styles";
```
