...
Virtari sidebar — accessible React component built on CSS variables and logical properties.
...
```bash
npm install @virtari-packages/react-sidebar
# or
pnpm add @virtari-packages/react-sidebar
# or
yarn add @virtari-packages/react-sidebar
```
...
```tsx
import { /* … */ } from "@virtari-packages/react-sidebar";
```

### Import styles

```ts
import "@virtari-packages/react-sidebar/styles";
```
