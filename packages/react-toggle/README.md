...
```bash
npm install @virtari-packages/react-toggle
# or
pnpm add @virtari-packages/react-toggle
# or
yarn add @virtari-packages/react-toggle
```
...
```tsx
import { /* … */ } from "@virtari-packages/react-toggle";
```
