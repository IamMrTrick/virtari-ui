# @virtari/react-toggle

Virtari toggle — accessible React component built on CSS variables and logical properties.
...
```bash
npm install @virtari/react-toggle
# or
pnpm add @virtari/react-toggle
# or
yarn add @virtari/react-toggle
```
...
```tsx
import { /* … */ } from "@virtari/react-toggle";
```

### Import styles

```ts
import "@virtari/react-toggle/styles";
```
