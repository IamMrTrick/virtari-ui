...
import { IconCircleFilled, IconColorSwatch, IconCode, IconArrowsLeftRight, IconRepeat, IconPlus, IconGripVertical, IconMinus, IconCheck, IconCopy, IconColorPicker } from '@virtari-packages/react-icons';
import { cn } from '@virtari-packages/utils';
import { forwardRef, useRef, useMemo, useState, useId, useEffect, useCallback } from 'react';
...
function SliderControl({
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsx("span", { className: "vds-color-picker-slider-track", style: { background } }),
        /* @__PURE__ */ jsx(
          "span",
          {
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx("span", { id: labelId, className: "vds-color-picker-sr-only", children: "Use arrow keys to adjust saturation and brightness." }),
        /* @__PURE__ */ jsxs("div", { className: "vds-color-picker-slider-stack", children: [
          /* @__PURE__ */ jsxs("div", { className: "vds-color-picker-slider-row", children: [
            eyeDropperSupported ? /* @__PURE__ */ jsx(
              PickerButton,
              {
                ...
                disabled,
                leftSection: /* @__PURE__ */ jsx(IconColorPicker, { size: 16, stroke: 1.75, "aria-hidden": "true" })
              }
            ) : /* @__PURE__ */ jsx("span", { className: "vds-color-picker-slider-spacer", "aria-hidden": "true" }),
            /* @__PURE__ */ jsx(
              SliderControl,
              {
                ariaLabel: "Hue",
          ...
          allowAlpha ? /* @__PURE__ */ jsxs("div", { className: "vds-color-picker-slider-row", children: [
            /* @__PURE__ */ jsx("span", { className: "vds-color-picker-slider-spacer", "aria-hidden": "true" }),
            /* @__PURE__ */ jsx(
              SliderControl,
              {
        ...
        /* @__PURE__ */ jsxs("div", { className: "vds-color-picker-value-bar", children: [
          /* @__PURE__ */ jsxs(
            Select,
            {
              value: format,
              ...
              children: [
                ...
                /* @__PURE__ */ jsx(SelectContent, { size: "xs", children: FORMAT_OPTIONS.map((option) => /* @__PURE__ */ jsx(SelectItem, { value: option.format, children: option.label }, option.format)) })
              ]
            }
          ),
          /* @__PURE__ */ jsx("div", { className: "vds-color-picker-value-fields", "data-format": format, children: fields.map((field, index) => /* @__PURE__ */ jsxs(
            "div",
            {
              className: "vds-color-picker-value-field",
              "data-wide": field.wide ? "true" : void 0,
              children: [
                /* @__PURE__ */ jsx("span", { className: "vds-color-picker-sr-only", children: field.label }),
                /* @__PURE__ */ jsxs(
                  "span",
                  {
                    ...
                    children: [
                      field.label === "Hex" ? /* @__PURE__ */ jsx("span", { className: "vds-color-picker-field-prefix", children: "#" }) : null,
                      field.inputMode === "text" ? /* @__PURE__ */ jsx(
                        HexField,
                        {
                      ...
                      field.unit ? /* @__PURE__ */ jsx("span", { className: "vds-color-picker-field-unit", children: field.unit }) : null
                    ]
                  }
                )
              ]
...
var ColorPicker = forwardRef(function ColorPicker2({
  ...
  const activeStopSnapshotRef = useRef(null);
  const lastGradientTypeRef = useRef(
    initialValue.type === "solid" ? "linear" : initialValue.type
  );
  const lastGradientValueRef = useRef(
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      ...props,
      children: [
        showHeader ? /* @__PURE__ */ jsxs("div", { className: "vds-color-picker-header", children: [
          showModeStrip ? /* @__PURE__ */ jsx("div", { className: "vds-color-picker-mode-strip", role: "tablist", "aria-label": "Picker mode", children: MODE_OPTIONS.map((option) => {
            ...
            return /* @__PURE__ */ jsx(
              PickerButton,
              {
                ...
                disabled,
                leftSection: /* @__PURE__ */ jsx(Icon, { size: 16, stroke: 1.75, "aria-hidden": "true" })
              },
              option.mode
            );
          }) }) : /* @__PURE__ */ jsx("span", { "aria-hidden": "true" }),
          showCodeView ? /* @__PURE__ */ jsx("div", { className: "vds-color-picker-header-actions", children: /* @__PURE__ */ jsx(
            PickerButton,
            {
              iconOnly: true,
              ...
              disabled,
              leftSection: /* @__PURE__ */ jsx(IconCode, { size: 16, stroke: 1.75, "aria-hidden": "true" })
            }
          ) }) : null
        ] }) : null,
        currentView === "code" && showCodeView ? /* @__PURE__ */ jsx(
          "div",
          {
        ...
        currentView !== "code" && !isGradient ? /* @__PURE__ */ jsx(
          SolidEditor,
          {
            color: activeColor,
            format: currentFormat,
        ...
        ) : currentView !== "code" && isGradient ? /* @__PURE__ */ jsxs("div", { className: "vds-color-picker-gradient-section", children: [
          /* @__PURE__ */ jsxs("div", { className: "vds-color-picker-gradient-topbar", children: [
            /* @__PURE__ */ jsxs(
              Select,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsx(SelectContent, { size: "xs", children: gradientTypeOptions.map((option) => /* @__PURE__ */ jsx(SelectItem, { value: option.type, children: option.label }, option.type)) })
                ]
              }
            ),
            /* @__PURE__ */ jsxs("div", { className: "vds-color-picker-gradient-actions", children: [
              /* @__PURE__ */ jsx(
                PickerButton,
                {
                  iconOnly: true,
                  ...
                  disabled,
                  leftSection: /* @__PURE__ */ jsx(IconArrowsLeftRight, { size: 16, stroke: 1.75, "aria-hidden": "true" })
                }
              ),
              "angle" in currentValue ? /* @__PURE__ */ jsxs(
                "label",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsx("span", { className: "vds-color-picker-inline-unit", children: "\xB0" })
                  ]
                }
              ) : /* @__PURE__ */ jsx(
                PickerButton,
                {
                  ...
                  disabled,
                  leftSection: /* @__PURE__ */ jsx(IconRepeat, { size: 16, stroke: 1.75, "aria-hidden": "true" })
                }
              )
            ] })
          ] }),
            ...
            "div",
            {
              ...
              children: gradientStops.map((stop) => /* @__PURE__ */ jsx(
                "button",
                {
                  ...
                  disabled,
                  children: /* @__PURE__ */ jsx("span", { className: "vds-color-picker-stop-swatch" })
                },
                stop.id
              ))
            }
          ),
          /* @__PURE__ */ jsxs("div", { className: "vds-color-picker-stop-list", children: [
            /* @__PURE__ */ jsxs("div", { className: "vds-color-picker-stop-list-header", children: [
              /* @__PURE__ */ jsx("span", { children: "Stops" }),
              /* @__PURE__ */ jsx(
                PickerButton,
                {
                  iconOnly: true,
                  ...
                  disabled,
                  leftSection: /* @__PURE__ */ jsx(IconPlus, { size: 14, stroke: 2, "aria-hidden": "true" })
                }
              )
            ] }),
            gradientStops.map((stop) => /* @__PURE__ */ jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsx(
                    "button",
                    {
                      ...
                      disabled,
                      tabIndex: -1,
                      children: /* @__PURE__ */ jsx(IconGripVertical, { size: 14, stroke: 1.75, "aria-hidden": "true" })
                    }
                  ),
                  /* @__PURE__ */ jsxs("div", { className: "vds-color-picker-stop-cell", children: [
                    /* @__PURE__ */ jsx(
                      NumberField,
                      {
                    ...
                    /* @__PURE__ */ jsx("span", { className: "vds-color-picker-stop-cell-suffix", "aria-hidden": "true", children: "%" })
                  ] }),
                  /* @__PURE__ */ jsxs("div", { className: "vds-color-picker-stop-hex", children: [
                    /* @__PURE__ */ jsxs(
                      Popover,
                      {
                  ...
                  /* @__PURE__ */ jsx(
                    PickerButton,
                    {
                      ...
                      leftSection: /* @__PURE__ */ jsx(IconMinus, { size: 14, stroke: 2, "aria-hidden": "true" })
                    }
                  )
                ]
              },
          ...
          "shape" in currentValue || "centerX" in currentValue ? /* @__PURE__ */ jsxs("div", { className: "vds-color-picker-gradient-meta", children: [
            "shape" in currentValue ? /* @__PURE__ */ jsxs(
              Select,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsx(SelectContent, { size: "xs", children: SHAPE_OPTIONS.map((option) => /* @__PURE__ */ jsx(SelectItem, { value: option.shape, children: option.label }, option.shape)) })
                ]
              }
            ) : null,
            "centerX" in currentValue ? /* @__PURE__ */ jsxs(Fragment, { children: [
              /* @__PURE__ */ jsxs(
                "label",
                {
                  className: "vds-color-picker-inline-chip",
                  ...
                  children: [
                    /* @__PURE__ */ jsx("span", { className: "vds-color-picker-inline-label", children: "X" }),
                    /* @__PURE__ */ jsx(
                      NumberField,
                      {
                    ...
                    /* @__PURE__ */ jsx("span", { className: "vds-color-picker-inline-unit", children: "%" })
                  ]
                }
              ),
              /* @__PURE__ */ jsxs(
                "label",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsx("span", { className: "vds-color-picker-inline-label", children: "Y" }),
                    /* @__PURE__ */ jsx(
                      NumberField,
                      {
        ...
        currentView !== "code" && swatchColors.length ? /* @__PURE__ */ jsx("div", { className: "vds-color-picker-swatches", "aria-label": "Swatches", children: swatchColors.map((swatch, index) => /* @__PURE__ */ jsx(
          "button",
          {
            type: "button",
        ...
        currentView === "code" && showCodeView ? /* @__PURE__ */ jsxs("div", { className: "vds-color-picker-code-panel", children: [
          /* @__PURE__ */ jsxs("div", { className: "vds-color-picker-code-header", children: [
            /* @__PURE__ */ jsx("span", { children: "Code" }),
            /* @__PURE__ */ jsxs("div", { className: "vds-color-picker-code-actions", children: [
              /* @__PURE__ */ jsx(
                PickerButton,
                {
                  iconOnly: true,
                  ...
                  disabled,
                  leftSection: copied ? /* @__PURE__ */ jsx(IconCheck, { size: 16, stroke: 2, "aria-hidden": "true" }) : /* @__PURE__ */ jsx(IconCopy, { size: 16, stroke: 1.75, "aria-hidden": "true" })
                }
              ),
              /* @__PURE__ */ jsx(
                Button,
          ...
          codeError ? /* @__PURE__ */ jsx("span", { className: "vds-color-picker-code-error", children: codeError }) : null
        ] }) : null
      ]
    }
  );
