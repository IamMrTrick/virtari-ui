...
import { SerializedEditorState, LexicalEditor, EditorState, DecoratorNode, DOMConversionMap, SerializedLexicalNode, NodeKey, EditorConfig, DOMExportOutput, LexicalNode, Klass, InitialEditorStateType, EditorThemeClasses } from 'lexical';
...
type EditorBlockType = "paragraph" | "h1" | "h2" | "h3" | "quote" | "code" | "bullet" | "number" | "check";
