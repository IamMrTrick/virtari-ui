...
```bash
npm install @virtari/react-dropdown-menu
# or
pnpm add @virtari/react-dropdown-menu
# or
yarn add @virtari/react-dropdown-menu
```
...
```tsx
import { /* ... */ } from "@virtari/react-dropdown-menu";
```

### Import styles

```ts
import "@virtari/react-dropdown-menu/styles";
```
