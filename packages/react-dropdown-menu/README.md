...
Virtari dropdown menu — accessible React component built on CSS variables and logical properties.
...
```bash
npm install @virtari-packages/react-dropdown-menu
# or
pnpm add @virtari-packages/react-dropdown-menu
# or
yarn add @virtari-packages/react-dropdown-menu
```
...
```tsx
import { /* … */ } from "@virtari-packages/react-dropdown-menu";
```

### Import styles

```ts
import "@virtari-packages/react-dropdown-menu/styles";
```
