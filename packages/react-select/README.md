...
```bash
npm install @virtari/react-select
# or
pnpm add @virtari/react-select
# or
yarn add @virtari/react-select
```
...
```tsx
import { /* ... */ } from "@virtari/react-select";
```

### Import styles

```ts
import "@virtari/react-select/styles";
```
