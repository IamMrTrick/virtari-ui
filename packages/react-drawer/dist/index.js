import { createContext, useState, useRef, useCallback, useLayoutEffect, useContext } from 'react';
...
function Drawer({
  ...
  return /* @__PURE__ */ jsx(
    DrawerProvider,
    {
      ...
      children: /* @__PURE__ */ jsx(DialogPrimitive.Root, { open: visible, onOpenChange, modal, children })
    }
  );
}
...
function DrawerContent({
  ...
  return /* @__PURE__ */ jsxs(DialogPrimitive.Portal, { forceMount: void 0, children: [
...
function DrawerTitle({ className, ref, ...props }) {
  return /* @__PURE__ */ jsx(DialogPrimitive.Title, { ref, className: cn("vds-drawer-title", className), ...props });
}
function DrawerDescription({ className, ref, ...props }) {
  return /* @__PURE__ */ jsx(DialogPrimitive.Description, { ref, className: cn("vds-drawer-description", className), ...props });
}
function DrawerBody({ className, ref, ...props }) {
  return /* @__PURE__ */ jsx("div", { ref, className: cn("vds-drawer-body", className), ...props });
}
function DrawerFooter({ className, ref, ...props }) {
  return /* @__PURE__ */ jsx("div", { ref, className: cn("vds-drawer-footer", className), ...props });
}
