...
Virtari drawer — accessible React component built on CSS variables and logical properties.
...
```bash
npm install @virtari-packages/react-drawer
# or
pnpm add @virtari-packages/react-drawer
# or
yarn add @virtari-packages/react-drawer
```
...
```tsx
import { /* … */ } from "@virtari-packages/react-drawer";
```
