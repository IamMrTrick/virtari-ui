...
```bash
npm install @virtari/react-progress
# or
pnpm add @virtari/react-progress
# or
yarn add @virtari/react-progress
```
...
```tsx
import { /* … */ } from "@virtari/react-progress";
```

### Import styles

```ts
import "@virtari/react-progress/styles";
```
