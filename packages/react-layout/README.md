...
```bash
npm install @virtari/react-layout
# or
pnpm add @virtari/react-layout
# or
yarn add @virtari/react-layout
```
...
```tsx
import { /* … */ } from "@virtari/react-layout";
```

### Import styles

```ts
import "@virtari/react-layout/styles";
```
