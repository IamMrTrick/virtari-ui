/**
 * Generate @virtari/utilities CSS.
 *
 ...
 * `@virtari/tokens` so consumer theming cascades through.
 */
...
function main() {
  ...
  let out = "";
  out += "/* @virtari/utilities — generated by scripts/generate.mjs. DO NOT EDIT BY HAND. */\n\n";
  out += breakpointDecls + "\n\n";
  out += "@layer utilities {\n";
  out += toCss(rules) + "\n";
  out += "}\n";
