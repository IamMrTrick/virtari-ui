...
```bash
npm install @virtari/react-radio-group
# or
pnpm add @virtari/react-radio-group
# or
yarn add @virtari/react-radio-group
```
...
```tsx
import { /* ... */ } from "@virtari/react-radio-group";
```

### Import styles

```ts
import "@virtari/react-radio-group/styles";
```
