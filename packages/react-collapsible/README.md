...
Virtari collapsible — accessible React component built on CSS variables and logical properties.
...
```bash
npm install @virtari-packages/react-collapsible
# or
pnpm add @virtari-packages/react-collapsible
# or
yarn add @virtari-packages/react-collapsible
```
...
```tsx
import { /* … */ } from "@virtari-packages/react-collapsible";
```

### Import styles

```ts
import "@virtari-packages/react-collapsible/styles";
```
