...
```bash
npm install @virtari/react-collapsible
# or
pnpm add @virtari/react-collapsible
# or
yarn add @virtari/react-collapsible
```
...
```tsx
import { /* ... */ } from "@virtari/react-collapsible";
```

### Import styles

```ts
import "@virtari/react-collapsible/styles";
```
