...
```bash
npm install @virtari/react-toast
# or
pnpm add @virtari/react-toast
# or
yarn add @virtari/react-toast
```
...
```tsx
import { /* … */ } from "@virtari/react-toast";
```

### Import styles

```ts
import "@virtari/react-toast/styles";
```
