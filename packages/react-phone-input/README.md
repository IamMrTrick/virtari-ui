...
```bash
npm install @virtari/react-phone-input
# or
pnpm add @virtari/react-phone-input
# or
yarn add @virtari/react-phone-input
```
...
```tsx
import { /* ... */ } from "@virtari/react-phone-input";
```

### Import styles

```ts
import "@virtari/react-phone-input/styles";
```
