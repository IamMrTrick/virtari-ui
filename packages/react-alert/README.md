...
```bash
npm install @virtari/react-alert
# or
pnpm add @virtari/react-alert
# or
yarn add @virtari/react-alert
```
...
```tsx
import { /* … */ } from "@virtari/react-alert";
```

### Import styles

```ts
import "@virtari/react-alert/styles";
```
