...
```bash
npm install @virtari/react-accordion
# or
pnpm add @virtari/react-accordion
# or
yarn add @virtari/react-accordion
```
...
```tsx
import { /* … */ } from "@virtari/react-accordion";
```

### Import styles

```ts
import "@virtari/react-accordion/styles";
```
