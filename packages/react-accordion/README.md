...
Virtari accordion — accessible React component built on CSS variables and logical properties.
...
```bash
npm install @virtari-packages/react-accordion
# or
pnpm add @virtari-packages/react-accordion
# or
yarn add @virtari-packages/react-accordion
```
...
```tsx
import { /* … */ } from "@virtari-packages/react-accordion";
```

### Import styles

```ts
import "@virtari-packages/react-accordion/styles";
```
