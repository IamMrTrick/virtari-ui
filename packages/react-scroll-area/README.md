...
```bash
npm install @virtari/react-scroll-area
# or
pnpm add @virtari/react-scroll-area
# or
yarn add @virtari/react-scroll-area
```
...
```tsx
import { /* … */ } from "@virtari/react-scroll-area";
```

### Import styles

```ts
import "@virtari/react-scroll-area/styles";
```
