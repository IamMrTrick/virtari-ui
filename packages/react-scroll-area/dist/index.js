...
function ScrollAreaArrow({
  ...
  return /* @__PURE__ */ jsx(
    "button",
    {
      ...
      ...rest,
      children: /* @__PURE__ */ jsx(ChevronIcon, { side, orientation })
    }
  );
}
            ...
            children: [
              /* @__PURE__ */ jsx(
                ScrollAreaPrimitive.Viewport,
                {
                  ...
                  children: marquee ? /* @__PURE__ */ jsx("div", { className: "vds-scroll-area-marquee", children: renderMarqueeItems(children) }) : /* @__PURE__ */ jsxs(Fragment, { children: [
                    children,
                    onEndReached && /* @__PURE__ */ jsx(
                      "div",
                      {
                        ref: sentinelRef,
...
function renderMarqueeItems(children) {
  ...
  return [0, 1].flatMap(
    (copy) => items.map((child, i) => /* @__PURE__ */ jsx(
      "div",
      {
...
export { ScrollArea, ScrollAreaArrow, ScrollBar };
