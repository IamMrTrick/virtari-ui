...
```bash
npm install @virtari-packages/react-spinner
# or
pnpm add @virtari-packages/react-spinner
# or
yarn add @virtari-packages/react-spinner
```
...
```tsx
import { /* … */ } from "@virtari-packages/react-spinner";
```

### Import styles

```ts
import "@virtari-packages/react-spinner/styles";
```
