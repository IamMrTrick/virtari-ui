...
```bash
npm install @virtari/react-slider
# or
pnpm add @virtari/react-slider
# or
yarn add @virtari/react-slider
```
...
```tsx
import { /* … */ } from "@virtari/react-slider";
```

### Import styles

```ts
import "@virtari/react-slider/styles";
```
