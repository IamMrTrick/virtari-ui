...
function Fieldset({ invalid, disabled, className, children, ref, ...props }) {
  return /* @__PURE__ */ jsxRuntime.jsx(
    ...
    {
      ref,
      className: utils.cn("vds-fieldset", className),
      disabled,
...
function FieldsetLegend({ required, className, children, ref, ...props }) {
  return /* @__PURE__ */ jsxRuntime.jsxs("legend", { ref, className: utils.cn("vds-fieldset-legend", className), ...props, children: [
    children,
    required && /* @__PURE__ */ jsxRuntime.jsx("span", { className: "vds-fieldset-required", "aria-hidden": "true", children: "*" })
  ] });
}
function FieldsetDescription({ className, children, ref, ...props }) {
  return /* @__PURE__ */ jsxRuntime.jsx("p", { ref, className: utils.cn("vds-fieldset-description", className), ...props, children });
}
...
function renderMetaRow(kind, items) {
  ...
  const renderItems = (slotItems, align) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx("div", { className: "vds-field-meta-slot", "data-align": align, children: slotItems.map((item, index) => /* @__PURE__ */ jsxRuntime.jsx(
      "div",
      {
        id: item.id,
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "vds-field-meta-row", "data-kind": kind, children: [
...
function Field({
  ...
  const labelClassName = utils.cn("vds-field-label", labelPropsClassName);
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    ...
    {
      ref,
      className: utils.cn("vds-field", className),
      "data-invalid": invalid || void 0,
      "data-disabled": disabled || void 0,
      "data-meta-layout": metaLayout,
      ...props,
      children: [
        label ? controlId ? /* @__PURE__ */ jsxRuntime.jsxs(
          "label",
          {
            htmlFor: controlId,
            ...
            children: [
              label,
              required ? /* @__PURE__ */ jsxRuntime.jsx("span", { className: "vds-field-required", "aria-hidden": "true", children: "*" }) : null
            ]
          }
        ...
        /* @__PURE__ */ jsxRuntime.jsx("div", { className: utils.cn("vds-field-control", controlClassName), children }),
        afterControl ? /* @__PURE__ */ jsxRuntime.jsx(
          "div",
          {
            className: utils.cn("vds-field-after-control", afterControlClassName),
            children: afterControl
          }
        ) : null,
        hasMeta ? /* @__PURE__ */ jsxRuntime.jsx("div", { className: utils.cn("vds-field-meta", metaClassName), children: metaRows }) : null
      ]
    }
  );
}
...
exports.composeFieldDescribedBy = composeFieldDescribedBy;
