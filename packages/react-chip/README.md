...
```bash
npm install @virtari-packages/react-chip
# or
pnpm add @virtari-packages/react-chip
# or
yarn add @virtari-packages/react-chip
```
...
```tsx
import { /* … */ } from "@virtari-packages/react-chip";
```
