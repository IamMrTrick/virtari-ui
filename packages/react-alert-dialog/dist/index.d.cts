...
type AlertDialogSize = "sm" | "md" | "lg" | "xl" | "full";
type AlertDialogAnimation = "scale" | "fade" | "slide-up" | "slide-down" | "zoom" | "bounce" | "none";
type AlertDialogIntent = "default" | "destructive" | "warning" | "success" | "info";
type AlertDialogBackdrop = "default" | "blur" | "blur-strong" | "light" | "none";
type AlertDialogHeaderVariant = "plain" | "bordered";
