...
Virtari popover — accessible React component built on CSS variables and logical properties.
...
```bash
npm install @virtari-packages/react-popover
# or
pnpm add @virtari-packages/react-popover
# or
yarn add @virtari-packages/react-popover
```
...
```tsx
import { /* … */ } from "@virtari-packages/react-popover";
```

### Import styles

```ts
import "@virtari-packages/react-popover/styles";
```
