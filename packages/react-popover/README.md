...
```bash
npm install @virtari/react-popover
# or
pnpm add @virtari/react-popover
# or
yarn add @virtari/react-popover
```
...
```tsx
import { /* … */ } from "@virtari/react-popover";
```

### Import styles

```ts
import "@virtari/react-popover/styles";
```
