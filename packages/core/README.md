...
```bash
npm install @virtari-packages/core
# or
pnpm add @virtari-packages/core
# or
yarn add @virtari-packages/core
```
...
```tsx
import { /* … */ } from "@virtari-packages/core";
```

### Import styles

```ts
import "@virtari-packages/core/styles";
```
