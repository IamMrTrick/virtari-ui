...
```bash
npm install @virtari-packages/react-label
# or
pnpm add @virtari-packages/react-label
# or
yarn add @virtari-packages/react-label
```
...
```tsx
import { /* … */ } from "@virtari-packages/react-label";
```
