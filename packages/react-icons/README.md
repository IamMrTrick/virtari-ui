...
Virtari icons — accessible React component built on CSS variables and logical properties.
...
```bash
npm install @virtari-packages/react-icons
# or
pnpm add @virtari-packages/react-icons
# or
yarn add @virtari-packages/react-icons
```
...
```tsx
import { /* … */ } from "@virtari-packages/react-icons";
```

### Import styles

```ts
import "@virtari-packages/react-icons/styles";
```
