...
```bash
npm install @virtari/react-icons
# or
pnpm add @virtari/react-icons
# or
yarn add @virtari/react-icons
```
...
```tsx
import { /* … */ } from "@virtari/react-icons";
```

### Import styles

```ts
import "@virtari/react-icons/styles";
```
