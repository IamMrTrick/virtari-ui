...
```bash
npm install @virtari/react-separator
# or
pnpm add @virtari/react-separator
# or
yarn add @virtari/react-separator
```
...
```tsx
import { /* ... */ } from "@virtari/react-separator";
```

### Import styles

```ts
import "@virtari/react-separator/styles";
```
