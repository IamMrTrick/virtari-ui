...
Virtari separator — accessible React component built on CSS variables and logical properties.
...
```bash
npm install @virtari-packages/react-separator
# or
pnpm add @virtari-packages/react-separator
# or
yarn add @virtari-packages/react-separator
```
...
```tsx
import { /* … */ } from "@virtari-packages/react-separator";
```

### Import styles

```ts
import "@virtari-packages/react-separator/styles";
```
