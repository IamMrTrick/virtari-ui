...
```bash
npm install @virtari/react-badge
# or
pnpm add @virtari/react-badge
# or
yarn add @virtari/react-badge
```
...
```tsx
import { /* ... */ } from "@virtari/react-badge";
```

### Import styles

```ts
import "@virtari/react-badge/styles";
```
