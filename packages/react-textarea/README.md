# @virtari/react-textarea

Virtari textarea — accessible React component built on CSS variables and logical properties.
...
```bash
npm install @virtari/react-textarea
# or
pnpm add @virtari/react-textarea
# or
yarn add @virtari/react-textarea
```
...
```tsx
import { /* ... */ } from "@virtari/react-textarea";
```

### Import styles

```ts
import "@virtari/react-textarea/styles";
```
