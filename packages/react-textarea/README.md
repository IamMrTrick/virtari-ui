...
```bash
npm install @virtari-packages/react-textarea
# or
pnpm add @virtari-packages/react-textarea
# or
yarn add @virtari-packages/react-textarea
```
...
```tsx
import { /* … */ } from "@virtari-packages/react-textarea";
```
