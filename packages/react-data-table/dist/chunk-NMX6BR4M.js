"use client";
import { createContext, forwardRef, useRef, Children, useEffect, useMemo, memo, useCallback, useState, useContext, isValidElement, cloneElement, useId } from 'react';
...
function DataTableColGroup() {
  ...
  return /* @__PURE__ */ jsx("colgroup", { className: "vds-data-table-colgroup", children: leafColumns.map((column) => /* @__PURE__ */ jsx(
    "col",
    {
...
var DataTableScrollArea = forwardRef(function DataTableScrollArea2({ className, children, scrollDrag = true, ...props }, ref) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "vds-data-table-scroll-shell", children: [
...
var DataTableHeader = forwardRef(function DataTableHeader2({
  className,
  children,
  stickyOffset,
  style,
...
var DataTableFooter = forwardRef(function DataTableFooter2({ className, children, sticky = false, stickyOffset, style, ...props }, ref) {
  const { table } = useDataTableContext();
