...
var DataTableScrollArea = react.forwardRef(function DataTableScrollArea2({ className, children, scrollDrag = true, ...props }, ref) {
...
var DataTableHeader = react.forwardRef(function DataTableHeader2({ className, children, stickyOffset, style, ...props }, ref) {
...
var DataTableFooter = react.forwardRef(function DataTableFooter2({ className, children, sticky = false, stickyOffset, style, ...props }, ref) {
  const { table } = useDataTableContext();
...
function DataTableColumnGuide() {
  ...
  if (scrollEl && rootEl) {
    ...
    if (!metrics || metrics.resizingId !== resizingId || metrics.scrollEl !== scrollEl || metrics.rootEl !== rootEl) {
      const rootRect = rootEl.getBoundingClientRect();
    ...
    guideStyle = {
      ["--data-table-guideline-offset"]: `${pointerClientX - metrics.rootLeft}px`,
      ["--data-table-guideline-top"]: `${metrics.scrollTop - metrics.rootTop}px`,
      ["--data-table-guideline-height"]: `${metrics.scrollHeight}px`
    };
  }
  return /* @__PURE__ */ jsxRuntime.jsx(
    "div",
...
function PaginationPageSize({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: utils.cn("vds-data-table-pagination-page-size", className), children: [
    /* @__PURE__ */ jsxRuntime.jsx(
      "span",
      {
        id: labelId,
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(
      reactSelect.Select,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsx(reactSelect.SelectContent, { children: options.map((n) => /* @__PURE__ */ jsxRuntime.jsx(reactSelect.SelectItem, { value: String(n), children: n }, n)) })
        ]
      }
    )
  ] });
...
function PaginationDefault({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    PaginationRoot,
    {
      ...
      stickyOffset,
      children: [
        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "vds-data-table-pagination-meta", children: [
...
var DEFAULT_ICONS = {
  table: /* @__PURE__ */ jsxRuntime.jsx(reactIcons.IconTable, { ...DEFAULT_ICON_PROPS }),
  board: /* @__PURE__ */ jsxRuntime.jsx(reactIcons.IconLayoutBoard, { ...DEFAULT_ICON_PROPS }),
  list: /* @__PURE__ */ jsxRuntime.jsx(reactIcons.IconLayoutList, { ...DEFAULT_ICON_PROPS })
};
          ...
          children: modes.map((m) => {
            ...
            return /* @__PURE__ */ jsxRuntime.jsxs(
              reactTabs.TabsTrigger,
              {
                ...
                children: [
                  icon ? /* @__PURE__ */ jsxRuntime.jsx("span", { className: "vds-data-table-view-toggle-icon", children: icon }) : null,
