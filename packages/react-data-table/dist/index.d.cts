...
declare function PaginationDefault({ className, pageSizeOptions, hidePageSize, hidePageNumbers, sticky, stickyOffset, }: PaginationDefaultProps): react_jsx_runtime.JSX.Element;
