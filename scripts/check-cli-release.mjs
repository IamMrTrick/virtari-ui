...
if (rootLicense.replace(/\r\n/g, "\n") !== cliLicense.replace(/\r\n/g, "\n")) failures.push("packages/cli/LICENSE must match the repository LICENSE.");
if (manifest.license !== "MIT") failures.push("The CLI package manifest must declare the MIT license.");
