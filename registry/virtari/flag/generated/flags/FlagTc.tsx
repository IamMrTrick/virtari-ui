// AUTO-GENERATED. DO NOT EDIT. Source: flag-icons/flags/4x3/tc.svg
import type { FC } from "react";
import { cn } from "../../../../lib/utils";
import type { FlagCoreProps } from "../../Flag";

const FlagTc: FC<FlagCoreProps> = ({
  size,
  rounded = true,
  title,
  className,
    ...
    <g strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.2">
      ...
      <g fill="#9e540a" transform="translate(535 249.6)scale(.125)">
        <g id="tc-b">
          ...
          <g stroke="none">
            <use xlinkHref="#tc-a" width="100%" height="100%" stroke="#fcd116" strokeWidth="12"/>
        ...
        <use xlinkHref="#tc-b" width="100%" height="100%" transform="scale(-1 1)"/>
        <g id="tc-c">
        ...
        <use xlinkHref="#tc-c" width="100%" height="100%" transform="scale(-1 1)"/>
      </g>
      <g transform="translate(485 299.6)scale(.125)">
        ...
        <use xlinkHref="#tc-d" width="100%" height="100%" transform="scale(-1 1)"/>
