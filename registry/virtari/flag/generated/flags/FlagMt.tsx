// AUTO-GENERATED. DO NOT EDIT. Source: flag-icons/flags/4x3/mt.svg
import type { FC } from "react";
import { cn } from "../../../../lib/utils";
import type { FlagCoreProps } from "../../Flag";

const FlagMt: FC<FlagCoreProps> = ({
  size,
  rounded = true,
  title,
  className,
  ...
  <g fill="#fff" stroke="#000" strokeWidth="96" transform="translate(161.8 160.6)scale(.0147)">
    <path fill="none" stroke="#cf142b" strokeWidth="512" d="M-2048-7168h4096v3890.8A1094 964 45 0 1 3277.2-2048H7168v4096H3277.2A964 1094 45 0 1 2048 3277.2V7168h-4096V3277.2A1094 964 45 0 1-3277.2 2048H-7168v-4096h3890.8A964 1094 45 0 1-2048-3277.2Z"/>
    ...
    <path strokeWidth="48" d="M-2024-7144h4048V7144h-4048zm-5120 5120H7144v4048H-7144Z"/>
  ...
  <g fill="none" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="36">
    ...
    <path fill="#fff" strokeWidth=".4" d="M168.2 191.2c.3.1.6.8.6.8s-.6.3-.8.2l-29.5-8.8c-.8-.2-.5-1.6.4-1.3zm-28-41q-.4-1.1-1.2-1.3c-.2 0-.9.7-.8.9 0 .4.9 1 1.2 1zm2.7 1-2.5 2.5c-.3.3.3.8.6.5l2.5-2.4c.3-.3-.3-.9-.6-.6m-1.2 2.4 7.7 7.9 1.5.2-.2-1.6-8-7.6z"/>
    <path strokeWidth=".1" d="m149.8 160.6-7.6-7.6"/>
    <path fill="#fff" strokeWidth=".5" d="M160 138.6q0-.7.5-1c.5-.3.3-.1.6 0l.8.5q.3.2.4 0 0-.4.3-.8l.2-.2q.3 0 .2-.3t.3-.4c.2 0 .6.3.6 0l.3-1.6c.6.1.4-.6.6-.6.6.2.9-.8.5-1.2q.1-1.1 1.7-1c-.1-.5-.9-.7-1.4-1.4s-2-1.6-3.8-1.6-3.1 1.6-3.8 2.3-2 1-2.3 1l-1-.4H153c-.6 0-.8.4-1.5.3-.4 0-2 0-2.5.2s0 1.2.5 1.3c.2 0 1.5 0 2 .3s2 .4 2.6.1c1.3-.4 2.1.4 3.5.8l.5.1q.1 1.2-.4 1.1h-1.2l-1.3-.6q-.9 0-1.2.2c-1.7.7-7.7 5.4-8.3 6.5-.7 1.2-1.7 1.9-2.6 3.7-.5 1-1.5 2.2-2.1 3.8-1 .5-2.1 1.4-2.3 1.7q0 .4.4.6 0 .3.6.5-.1.4.4.4 0 .5.5.7l2.4-2.5q.2-1.7 1-2.8a41 41 0 0 0 3.4-4.9c.3-.4 3.2-1.5 4-2.2a14 14 0 0 0 0 4.6c.5 2 1.1 3.3 1.5 5s0 2.7 0 3.5q0 .7 1 1c.5.4 2.9 0 3.6.3l3.1.6a5 5 0 0 1 3.5.6c.6.5 1.7 3 2.1 4s2.6 2.1 3 2.7c.5.5.9 2 .8 2.7q-.2 1 .7.8c.5 0 2.5.3 2.8.5.4.2 1.2.9 1.5.9s1.7.2 2.4.1.6-1.1.3-1.2l-2-.4a8 8 0 0 1-2.7-2.1q-.8-1.2-1.3-2.5l-3.1-4.5-1.6-3.8c-.3-.7-.8-.7-1.3-.9-1.8-.5-2.5-.7-4.4-1-1.3-.3-1.6-.4-1.8-1.4 0-.8-.6-2.2-.3-3.2l.4-1.8c0-.5.4-1.3.4-1.7l.2-3zm1.4 8.2c-.2 0-1 .2-1.5 0-.1 0 0-.4 0-.4s-.2-.3 0-.4q-.1-.2 0-.4-.3-.3 0-.5l1.4-.1q.4.9.1 1.8"/>
    <path strokeWidth=".5" d="M158.1 135.1c.4.3.4 0 1.1-.2s1.3.4 1 1q-.4 1 .6 1.2c1 .2 1-.7 1.2-1l.7-.7c.2-.8 1-.6 1.5-.5m1-1.9c-.3.2-1.2-.5-1.4-1.1q-.3-1.3-1.8-1.4c-1.5-.1-3 .6-3.3 1.7l-.3 1.7q-.6 0-.7.2l-.1.8m-6.3 6.3 2-1"/>
    <path strokeWidth=".3" d="M153.4 140.3c.5 1.3 1 2.6 1.7 3m1.1.5q1.2.6 2.5.2m-5.1 9.5c2.1 0 3 1 4.7 1.6 1.8.5 4.2.2 6.5 1.3m-11.9-9.7q1 .6 2 .6m.9 0q1.8.4 2.3 1.4m-2.8 1.1c1 1 3 1.8 4.2 1.8"/>
    <path strokeWidth=".2" d="M157 136c.9 3.2 1 4.4 3.2 5m-4.1-5.1c1 3.1 2 4.8 4.1 5m-5-5.4c1 3.1 2.4 5.3 5 5.4m11.6 24.8q-.6-.4-1-1.3l-.7-1.6-.5.3q-.6 0-.2-.4l.4-.2-.6-1.2q-.3 0 .2-.3t.4 0l.6 1.2.4-.2c.3-.2.5.3.2.4l-.5.2.8 1.6c.4.7.5.9.5 1.5m-.1-3.4-2.4 1.3m-2.2-1.8 3.2-1.6m-3.7 1 3.3-1.6"/>
    <path strokeWidth=".1" d="m140.1 153 1.1-1m-1.5.5 1-1m-1.6.5 1.1-1m19.8-4.6h1m-1.1-.8h1m-1 .4h1m1.3-9.2.6.3"/>
  </g>
  </svg>
);
