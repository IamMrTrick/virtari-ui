// AUTO-GENERATED. DO NOT EDIT. Source: flag-icons/flags/4x3/ke.svg
import type { FC } from "react";
import { cn } from "../../../../lib/utils";
import type { FlagCoreProps } from "../../Flag";

const FlagKe: FC<FlagCoreProps> = ({
  size,
  rounded = true,
  title,
  className,
  ...
  >
    ...
    <defs>
    <path id="ke-a" strokeMiterlimit="10" d="m-28.6 47.5 1.8 1 46.7-81c2.7-.6 4.2-3.2 5.7-5.8 1-1.8 5-8.7 6.7-17.7a58 58 0 0 0-11.9 14.7c-1.5 2.6-3 5.2-2.3 7.9z"/>
  </defs>
  ...
  <use xlinkHref="#ke-b" width="100%" height="100%" transform="matrix(-1 0 0 1 640 0)"/>
  ...
  <use xlinkHref="#ke-c" width="100%" height="100%" transform="matrix(-1 0 0 1 640 0)"/>
  <g fill="#fff" transform="matrix(3 0 0 3 320 240)">
    <ellipse rx="4" ry="6"/>
    <path id="ke-d" d="M1 5.8s4 8 4 21-4 21-4 21z"/>
    <use xlinkHref="#ke-d" width="100%" height="100%" transform="scale(-1)"/>
    <use xlinkHref="#ke-d" width="100%" height="100%" transform="scale(-1 1)"/>
    <use xlinkHref="#ke-d" width="100%" height="100%" transform="scale(1 -1)"/>
  </g>
  </svg>
);
