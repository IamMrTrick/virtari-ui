// AUTO-GENERATED. DO NOT EDIT. Source: flag-icons/flags/4x3/li.svg
import type { FC } from "react";
import { cn } from "../../../../lib/utils";
import type { FlagCoreProps } from "../../Flag";

const FlagLi: FC<FlagCoreProps> = ({
  size,
  rounded = true,
  title,
  className,
  ...
  <g fill="#ffd83d" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" transform="scale(.8)">
    <g id="li-a">
    ...
    <use xlinkHref="#li-a" width="100%" height="100%" transform="matrix(-1 0 0 1 444 0)"/>
    ...
    <path fill="none" strokeWidth="1.5" d="M219.3 89.9v6.6a63 63 0 0 0-7.4.8m20.2 0a62 62 0 0 0-7.5-.8v-6.6m-12.8 12.7a61 61 0 0 1 10.2-.9q5.2 0 10 .9"/>
