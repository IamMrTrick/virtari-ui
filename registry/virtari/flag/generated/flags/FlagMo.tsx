// AUTO-GENERATED. DO NOT EDIT. Source: flag-icons/flags/4x3/mo.svg
import type { FC } from "react";
import { cn } from "../../../../lib/utils";
import type { FlagCoreProps } from "../../Flag";

const FlagMo: FC<FlagCoreProps> = ({
  size,
  rounded = true,
  title,
  className,
  ...
  <use xlinkHref="#mo-a" width="100%" height="100%" transform="matrix(-1 0 0 1 640 0)"/>
  </svg>
);
