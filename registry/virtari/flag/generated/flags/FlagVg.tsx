// AUTO-GENERATED. DO NOT EDIT. Source: flag-icons/flags/4x3/vg.svg
import type { FC } from "react";
import { cn } from "../../../../lib/utils";
import type { FlagCoreProps } from "../../Flag";

const FlagVg: FC<FlagCoreProps> = ({
  size,
  rounded = true,
  title,
  className,
  ...
  <g transform="translate(-217.5 -9.4)scale(.77497)">
    ...
    <path fill="#006129" stroke="#000" strokeWidth="1.9" d="m782.3 150.1 238.8-1.4v214.6c.5 28-46.5 56.3-119.9 92.5-75.7-39-119.4-62.7-119.8-93z"/>
    <g id="vg-b" fill="#ffc72c" stroke="#000" strokeWidth=".9">
      <path fill="none" stroke="#ffc72c" strokeWidth="1.9" d="m814.8 181.8 14-20.7 14.3 20.8"/>
    ...
    <g fill="#ffc6b5" stroke="#000" strokeWidth=".9">
      ...
      <g fill="none">
        ...
        <path strokeLinejoin="round" d="M894.1 188.2h2.9l-2.5 1.1M911.7 300s3.3-.4 3.2 5.2c2.1-7 6.4-7.1 6.4-7.1"/>
        <path strokeLinejoin="round" strokeWidth="1.7" d="M898.1 179.3c.5 0 2.2-.6 2.5-.1.4.4-1.9.8-2.5.1z"/>
      </g>
    </g>
