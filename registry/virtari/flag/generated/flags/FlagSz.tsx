// AUTO-GENERATED. DO NOT EDIT. Source: flag-icons/flags/4x3/sz.svg
import type { FC } from "react";
import { cn } from "../../../../lib/utils";
import type { FlagCoreProps } from "../../Flag";

const FlagSz: FC<FlagCoreProps> = ({
  size,
  rounded = true,
  title,
  className,
  ...
  <g fill="#ffd900" stroke="#000" transform="translate(-43.2)scale(1.2)">
    ...
    <rect width="485.7" height="8.6" x="59.8" y="195.7" strokeWidth="1.1" rx="4.2" ry="4.3"/>
  </g>
  <path fill="#fff" stroke="#000" strokeWidth="1.2" d="M488.2 240c-34.3 34.3-80 102.9-171.4 102.9-80 0-137.1-68.6-171.4-102.9 34.2-34.3 91.4-102.9 171.4-102.9 91.4 0 137.1 68.6 171.4 102.9z"/>
  ...
  <use xlinkHref="#sz-d" width="100%" height="100%" x="104.8" stroke="#000" transform="translate(-43.2)scale(1.2)"/>
  <g fill="#a70000">
