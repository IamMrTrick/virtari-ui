// AUTO-GENERATED. DO NOT EDIT. Source: flag-icons/flags/4x3/gd.svg
import type { FC } from "react";
import { cn } from "../../../../lib/utils";
import type { FlagCoreProps } from "../../Flag";

const FlagGd: FC<FlagCoreProps> = ({
  size,
  rounded = true,
  title,
  className,
  ...
  <use xlinkHref="#gd-c" width="100%" height="100%" transform="translate(320 240)scale(52.8)"/>
  <use xlinkHref="#gd-d" width="100%" height="100%" x="-100" transform="translate(-30.3)"/>
  <use xlinkHref="#gd-c" id="gd-d" width="100%" height="100%" transform="translate(320 33.6)scale(31.2)"/>
  <use xlinkHref="#gd-d" width="100%" height="100%" x="100" transform="translate(30.3)"/>
  ...
  <use xlinkHref="#gd-d" width="100%" height="100%" x="-100" transform="translate(-30.3 414.6)"/>
  <use xlinkHref="#gd-c" width="100%" height="100%" transform="translate(320 448.2)scale(31.2)"/>
  <use xlinkHref="#gd-d" width="100%" height="100%" x="100" transform="translate(30.3 414.6)"/>
  </svg>
);
