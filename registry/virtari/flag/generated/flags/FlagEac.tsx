// AUTO-GENERATED. DO NOT EDIT. Source: flag-icons/flags/4x3/eac.svg
import type { FC } from "react";
import { cn } from "../../../../lib/utils";
import type { FlagCoreProps } from "../../Flag";

const FlagEac: FC<FlagCoreProps> = ({
  size,
  rounded = true,
  title,
  className,
  ...
  <g transform="translate(41.1 674.6)scale(.87273)">
    ...
    <use xlinkHref="#eac-d" width="600" height="330" transform="matrix(-1 0 0 1 639.1 0)"/>
    <path fill="#ff0" stroke="#000" strokeWidth="1.2" d="M317.7-580A70.8 70.8 0 0 0 294-443.4v-7.8a63.5 63.5 0 0 1 25.2-121.6h.5a63.5 63.5 0 0 1 25.6 121.6v7.8A70.7 70.7 0 0 0 319.6-580z"/>
    <path fill="#fff" fillRule="evenodd" stroke="#000" strokeWidth=".9" d="m339-458.3.1 10.6c-6.4 1-13.5 7.6-15.4 8.8s-5 3.8-6.7 3.6c-2.9-.4-.8-2.7-.8-2.7s-2 2.4-3.4 1.3c-1.4-.9.8-2.7.8-2.7s-.7 1-2.2.5c-1.4-.4-.4-2-.4-2s-3.8 2-4.5 1.3c-1-1.3.4-2.5.4-2.5l8.9-7.5s-5.8 2.1 0 0c4.9-2 6.3.8 8.5.6a28 28 0 0 0 10.2-5.1c1.7-1.7 1.2-3.5 2.5-4s2-.2 2-.2z"/>
    <path fill="#fff" fillRule="evenodd" stroke="#000" strokeWidth=".8" d="m300-457.5-.1 9.8c6 .8 12.7 7.2 14.5 8.4 1.7 1.1 4.7 3 6.3 2.8 2.6-.3 2-1.3 2-1.3s1.2.6 2.8 0 .8-1.7.8-1.7 2.4.7 3.4-.6c1-1.1-1-2.3-1-2.3s1-.7-.6.2-4.8-2.8-8-3c-3.3 0-3.6 3.2-5.6 1.7-2.1-1.6 1.6-4.2 2.9-4.6 5.1-1.7 9.9.4 3.7-2-3.2-1.2-5.7 1.1-7.8 1-2.2-.1-7.6-3-9-4.6-1.6-1.6-1.2-3.2-2.4-3.7q-1.8-.4-2-.1z"/>
    <path fill="none" stroke="#000" strokeWidth=".8" d="m326.4-439.5-4.3-1.8m1.1 3.7-5-3"/>
    <g id="eac-e" fill="#008300" fillRule="evenodd" stroke="#000" strokeDasharray="none" strokeMiterlimit="4" strokeOpacity="1" strokeWidth=".4">
    ...
    <path fill="#fbf014" stroke="#000" strokeWidth=".4" d="M354.7-509.4a35.1 35.1 0 1 1-70.3 0 35.1 35.1 0 0 1 70.3 0z"/>
    <path fill="#fbf014" stroke="#000" strokeWidth=".4" d="M351.7-509.4a32.2 32.2 0 1 1-64.4 0 32.2 32.2 0 0 1 64.4 0z"/>
    ...
    <path fill="#fff" fillRule="evenodd" stroke="#000" strokeWidth=".5" d="M298.1-512.9c-.3-.3 1-1 .8-1.5q0-1.3 1.6-1.7l.6-.4c.3.2.3.7.6.4s1-1.3 1.5-1.1c-.3.4.3 1.2.7 1.5l.6 1.9q-.2.9-1.4.6c-.8-.3-1 .3-1.6-.2-.1.7 0 1.3-.9 1.6q-.9 0-1-.3-.7-.8-1.2 0-.2-.2-.3-.8" className="eac-landxx eac-rw"/>
    <path fill="#fff" fillRule="evenodd" stroke="#000" strokeWidth=".5" d="M298.4-512.1c.5-1.1 1.1.1 1.3.1 1.5.2 1.5-.1 1.8-1.5.8.6.5 0 2.2.4-.3 0-1 .8-.5.8-.4 1.1.5 1.1 1.1 1-.3.4.5.6-.3 1-.5.3-.5 0-.5.7l-.6.1c-.1.2.3.6.2.6q0 .2-.6.8t-1.3 1l-.7.2-1-1.8q0-.8-.3-1.6v-.9q-.5-.4-.8-1" className="eac-landxx eac-bi"/>
  </g>
  </svg>
);
