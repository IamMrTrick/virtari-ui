// AUTO-GENERATED. DO NOT EDIT. Source: flag-icons/flags/4x3/zw.svg
import type { FC } from "react";
import { cn } from "../../../../lib/utils";
import type { FlagCoreProps } from "../../Flag";

const FlagZw: FC<FlagCoreProps> = ({
  size,
  rounded = true,
  title,
  className,
  ...
  >
    ...
    <defs>
    <clipPath id="zw-a">
      <rect width="546" height="420.1" x="1.9" y=".1" fill="#00f" fillRule="evenodd" ry="0"/>
    </clipPath>
  </defs>
