// AUTO-GENERATED. DO NOT EDIT. Source: flag-icons/flags/4x3/vu.svg
import type { FC } from "react";
import { cn } from "../../../../lib/utils";
import type { FlagCoreProps } from "../../Flag";

const FlagVu: FC<FlagCoreProps> = ({
  size,
  rounded = true,
  title,
  className,
  ...
  <g clipPath="url(#vu-a)" transform="scale(.71111 1.01053)">
    <path stroke="#fdce12" strokeWidth="110" d="m0 0 420 195h480v85H420L0 475"/>
    <path fill="none" stroke="#000" strokeWidth="60" d="m0 0 420 195h480m0 85H420L0 475"/>
  </g>
  <g fill="#fdce12" transform="translate(-22)scale(1.01053)">
    ...
    <g id="vu-b">
      <path stroke="#fdce12" strokeWidth=".8" d="m86.2 247.7 1.4 1s11.2-25.5 41.1-43.6c-3.8 2-23.8 12-42.5 42.6z"/>
    ...
    <use xlinkHref="#vu-b" width="100%" height="100%" transform="matrix(-1 0 0 1 220 0)"/>
  </g>
  </svg>
);
