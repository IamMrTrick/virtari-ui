// AUTO-GENERATED. DO NOT EDIT. Source: flag-icons/flags/4x3/tj.svg
import type { FC } from "react";
import { cn } from "../../../../lib/utils";
import type { FlagCoreProps } from "../../Flag";

const FlagTj: FC<FlagCoreProps> = ({
  size,
  rounded = true,
  title,
  className,
  ...
  <use xlinkHref="#tj-a" width="100%" height="100%" fill="#f8c300" transform="matrix(-1 0 0 1 640 0)"/>
  ...
  <use xlinkHref="#tj-b" width="100%" height="100%" fill="#f8c300" transform="rotate(9.4 320 551.3)"/>
  <use xlinkHref="#tj-b" width="100%" height="100%" fill="#f8c300" transform="rotate(18.7 320 551.3)"/>
  ...
  <g id="tj-d" fill="#f8c300" transform="translate(320 260.6)scale(.68571)">
    <use xlinkHref="#tj-c" width="100%" height="100%" transform="translate(-70 -121.2)"/>
    <use xlinkHref="#tj-c" width="100%" height="100%" transform="translate(-121.2 -70)"/>
    <use xlinkHref="#tj-c" width="100%" height="100%" transform="translate(-140)"/>
  </g>
  <use xlinkHref="#tj-d" width="100%" height="100%" fill="#f8c300" transform="matrix(-1 0 0 1 640 0)"/>
  </svg>
);
