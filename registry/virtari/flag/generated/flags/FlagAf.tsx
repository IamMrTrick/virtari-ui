// AUTO-GENERATED. DO NOT EDIT. Source: flag-icons/flags/4x3/af.svg
import type { FC } from "react";
import { cn } from "../../../../lib/utils";
import type { FlagCoreProps } from "../../Flag";

const FlagAf: FC<FlagCoreProps> = ({
  size,
  rounded = true,
  title,
  className,
  ...
  <g fill="#fff" fillRule="evenodd" stroke="#bd6b00" strokeWidth=".5" transform="translate(1 27.3)scale(1.06346)">
    ...
    <use xlinkHref="#af-a" width="100%" height="100%" x="-600" transform="scale(-1 1)"/>
    <g stroke="none">
