// AUTO-GENERATED. DO NOT EDIT. Source: flag-icons/flags/4x3/gi.svg
import type { FC } from "react";
import { cn } from "../../../../lib/utils";
import type { FlagCoreProps } from "../../Flag";

const FlagGi: FC<FlagCoreProps> = ({
  size,
  rounded = true,
  title,
  className,
  ...
  <g stroke="#000" transform="translate(-160)scale(1.875)">
    ...
    <use xlinkHref="#gi-a" width="100%" height="100%" transform="matrix(-1 0 0 1 512 0)"/>
    <g fill="#f8d80e">
      <g strokeLinecap="round">
        <path strokeWidth=".8" d="M273.3 150q-3.9 1.6-7.5 3.8a72 72 0 0 0-8.9 6q-1.6 1-2.7 2.4c-1 .8-2 2-1.8 3.5 0 .6.8-.8 1.4-.9a4 4 0 0 1 3.1-.4q2.1-2 4.4-3.4a77 77 0 0 1 13-7.6z"/>
        <path d="M260.4 157.4v3.9m2.4-5.6v3.9m2.4-5.4v3.8m2.5-5.3v4"/>
        <path strokeWidth=".8" d="m238.9 150.2-1.2 3.3a87 87 0 0 1 15.8 8q2.7 1.6 4.8 3.9c.3.8-.5 1.5-1.3 1.2-.7-.2-1.5-.5-2.2 0-1.1.5-2.1 2.2-.5 2.7 2.4 1.6 6.1.9 7.2-1.8.6-1.4.7-3.2-.5-4.4-2-2.3-4.8-4-7.4-5.7a89 89 0 0 0-14.7-7.2z"/>
    ...
    <g fill="#da000c">
      ...
      <path strokeLinejoin="round" d="M228.7 102.4v54.4h12.8v-20.4c0-9.5 6.4-14 14.5-14 7.8 0 14.5 4.5 14.5 14v20.4h12.8v-54.4z"/>
    </g>
  </g>
  </svg>
);
