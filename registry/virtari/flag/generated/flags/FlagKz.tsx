// AUTO-GENERATED. DO NOT EDIT. Source: flag-icons/flags/4x3/kz.svg
import type { FC } from "react";
import { cn } from "../../../../lib/utils";
import type { FlagCoreProps } from "../../Flag";

const FlagKz: FC<FlagCoreProps> = ({
  size,
  rounded = true,
  title,
  className,
  ...
  <g fill="#ffec2d">
    <g transform="matrix(.48 0 0 .48 345.8 201.6)">
      ...
      <g id="kz-c">
        <g id="kz-b">
          ...
          <use xlinkHref="#kz-a" width="100%" height="100%" transform="rotate(90)"/>
          <use xlinkHref="#kz-a" width="100%" height="100%" transform="scale(-1)"/>
          <use xlinkHref="#kz-a" width="100%" height="100%" transform="rotate(-90)"/>
        </g>
        <use xlinkHref="#kz-b" width="100%" height="100%" transform="rotate(22.5)"/>
        <use xlinkHref="#kz-b" width="100%" height="100%" transform="rotate(45)"/>
        <use xlinkHref="#kz-b" width="100%" height="100%" transform="rotate(67.5)"/>
      </g>
      <use xlinkHref="#kz-c" width="100%" height="100%" transform="rotate(11.3)"/>
    </g>
    <g transform="translate(-172.8)scale(.48)">
      ...
      <circle cx="1019.8" cy="720.5" r="1" stroke="#ffec2d" strokeWidth=".4"/>
    </g>
    <g transform="scale(.48)">
      <g id="kz-f">
        <g id="kz-e">
          ...
          <use xlinkHref="#kz-d" width="100%" height="100%" transform="matrix(1 0 0 -1 0 645)"/>
        </g>
        <use xlinkHref="#kz-e" width="100%" height="100%" transform="matrix(-1 0 0 1 240 0)"/>
      </g>
      <use xlinkHref="#kz-f" width="100%" height="100%" transform="matrix(1 0 0 -1 0 1000)"/>
    </g>
  </g>
  </svg>
);
