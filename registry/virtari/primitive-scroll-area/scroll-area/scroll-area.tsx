      ...
      >
        <Primitive.div
          ...
          style={{
            ...
            ['--vds-scroll-area-corner-width' as any]: cornerWidth + 'px',
            ['--vds-scroll-area-corner-height' as any]: cornerHeight + 'px',
            ...props.style,
          }}
        />
      </ScrollAreaProvider>
  ...
  return (
    <ScrollAreaScrollbarImpl
      ...
      style={{
        ...
        ['--vds-scroll-area-thumb-width' as any]: getThumbSize(sizes) + 'px',
        ...props.style,
      }}
  ...
  return (
    <ScrollAreaScrollbarImpl
      ...
      style={{
        ...
        ['--vds-scroll-area-thumb-height' as any]: getThumbSize(sizes) + 'px',
        ...props.style,
      }}
