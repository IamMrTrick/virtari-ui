...
const BLOCK_OPTIONS: Array<{
  ...
  { label: "Heading 4", value: "h4", shortcut: SHORTCUTS.HEADING_4, icon: IconH4 },
  { label: "Heading 5", value: "h5", shortcut: SHORTCUTS.HEADING_5, icon: IconH5 },
  { label: "Heading 6", value: "h6", shortcut: SHORTCUTS.HEADING_6, icon: IconH6 },
