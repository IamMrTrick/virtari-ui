...
```tsx
{
  ...
  "properties": {
    ...
    "skills": {
      "type": "object",
      "additionalProperties": false,
      "description": "Install the portable Virtari Agent Skills bundle and project-level AI contract.",
      "properties": {
        "directory": {
          "type": "string",
          "description": "Project-relative directory that receives portable Agent Skills.",
          "default": ".agents/skills"
        },
        "install": {
          "type": "boolean",
          "description": "Install and validate Virtari skills during initialization.",
          "default": true
        }
      },
      "default": {
...
const DEFAULT_REGISTRY = `https://raw.githubusercontent.com/itstheilya/virtari-ui/cli-v${CLI_MANIFEST.version}/registry.json`;
...
async function commandInit(options) {
  ...
  if (!config) {
    config = {
      $schema: `https://raw.githubusercontent.com/itstheilya/virtari-ui/cli-v${CLI_MANIFEST.version}/virtari.schema.json`,
